...
require (
	...
	github.com/openshift/hypershift v0.1.51
	github.com/openshift/hypershift/api v0.0.0-20241119121522-a8eaa2efc3ef
	github.com/openshift/library-go v0.0.0-20241119082418-04467c6957c7
...
// Newer version of sigs.k8s.io/json is go1.23 based, remove this in 4.19
