...
func (b *Builder) BuildOrDie(ctx context.Context) *Clients {
	...
	guestOperatorClient, guestOperatorDynamicInformers, err := goc.NewClusterScopedOperatorClientWithConfigName(clock.RealClock{}, guestKubeConfig, gvr, gvk, b.csiDriverName, extractApplySpec, extractApplyStatus)
	if err != nil {
