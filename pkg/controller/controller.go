...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Uncomment watch a Deployment created by CSIDriverDeployment - change this for objects you create
...
// +kubebuilder:rbac:groups=csidriver.storage.okd.io,resources=csidriverdeployments,verbs=get;list;watch;create;update;patch;delete
