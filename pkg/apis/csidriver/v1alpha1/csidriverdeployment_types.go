...
// CSIDriverDeploymentSpec defines the desired state of CSIDriverDeployment
type CSIDriverDeploymentSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file
}

// CSIDriverDeploymentStatus defines the observed state of CSIDriverDeployment
...
// CSIDriverDeploymentList contains a list of CSIDriverDeployment
