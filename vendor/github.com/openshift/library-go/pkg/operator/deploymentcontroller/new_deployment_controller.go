...
func (c *MyController) WithPrecondition(preconditions []func(context.Context) (bool, error)) *MyController {
...
func (c *MyController) syncDeleting(ctx context.Context, required *appsv1.Deployment, opSpec *opv1.OperatorSpec) (*appsv1.Deployment, error) {
